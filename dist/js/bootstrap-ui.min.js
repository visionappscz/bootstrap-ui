...
a(b).load(function(){a("[data-onload-ckeditor]").each(function(){var b=a("html").attr("lang"),c={},d=a(this),e=d.data("onload-ckeditor");b&&(c.language=b),e&&(c="object"==typeof e?e:{customConfig:e}),d.ckeditor(c)})})}(a,b)}(jQuery,window),function(a,b,c){"use strict";
