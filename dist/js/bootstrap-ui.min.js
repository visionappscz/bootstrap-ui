...
a(b).load(function(){a("[data-onload-ckeditor]").each(function(){var b=a("html").attr("lang"),c={},d=a(this),e=d.data("onload-ckeditor");e&&(c="object"==typeof e?e:{customConfig:e}),b&&!c.hasOwnProperty("language")&&(c.language=b),d.ckeditor(c)})})}(a,b)}(jQuery,window),function(a,b,c){"use strict";
...
// We have to use $(winodow).load() as $(document).ready() can not be triggered manually
// and thus it would make it impossible to test this part of the code.
a(c).load(function(){var b=function(b){var c=new d(a(this)),e={allowInputToggle:!0,sideBySide:!0,locale:a("html").attr("lang")};b&&a.extend(e,b),c.init(e)};
// CKEDITOR-LOADER DATA-API
// ========================
...
// and thus it would make it impossible to test this part of the code.
b(c).load(function(){var c=b("[data-toggle=disable]");c.each(function(){var c=b(this),d=c.data("disable-event");d||(d="change"),c.on(d+".bui.disable.data-api",function(){a.call(b(c.data("disable-target")))})})})}(d,a,b)}(jQuery,window,document),function(a,b,c){"use strict";
...
// We have to use $(winodow).load() as $(document).ready() can not be triggered manually
// and thus it would make it impossible to test this part of the code.
a(b).load(function(){a("[data-onload-select2]").each(function(){var b={},c=a(this),d=c.data("onload-select2"),e=function(b){var c=a(b.element),d=c.data("image-src"),e=c.data("image-srcset"),f=c.data("image-height"),g=c.data("image-width"),h="";return d?(h='src="'+d+'" alt="'+b.text+'"',e&&(h=h+' srcset="'+e+'"'),f&&(h=h+' height="'+f+'"'),g&&(h=h+' width="'+g+'"'),"<img "+h+">&nbsp;"+b.id):b.id};d&&(b=d),b.formatSelection=e,b.formatResult=e,b.escapeMarkup=function(a){return a},c.select2(b)})})}(a,b)}(jQuery,window),function(a,b,c){"use strict";
...
// ================================
function d(b){return this.each(function(){var c,d=a(this),f=d.data("bui.sortableTable");f||(c=b&&"navigation"in b&&b.navigation?a(b.navigation):!1,f=new e(d,c),d.data("bui.sortableTable",f)),f.sort(b["sorted-th"],b["sort-direction"])})}
// SORTABLE TABLE CLASS DEFINITION
// ===============================
var e=function(a,b){this.$sortedTable=a,this.$navigation=b,b&&(this.colCount=a.find("tr")[0].childElementCount)};e.prototype.sort=function(b,c){var d,e,f,g,h,i,j,k=null,l="",m=b.hasClass("sorting-asc");for(this.$sortedTable.trigger("sort.bui.sortableTable").find("th").removeClass("sorting-asc").removeClass("sorting-desc"),m||"desc"===c?(c="desc",b.addClass("sorting-desc")):b.addClass("sorting-asc"),j=this.$sortedTable.find("tbody tr").toArray().sort(this.comparer(b.index(),c)),i=this.$navigation&&"undefined"!=typeof a(j[0]).children("td").eq(b.index()).data("sort-group"),g="<thead>"+this.$sortedTable.find("thead:eq(0)").html()+"</thead>",f=j.length,e=0;f>e;e++)h=j[e],i&&(d=a(h).children("td").eq(b.index()).data("sort-group"),k!==d&&(k=d,l+='<li><a href="#letter-'+d+'">'+d+"</a></li>",g+='<thead><tr class="active"><th colspan="'+this.colCount+'"><h2 class="h3" id="letter-'+k+'">'+k+"</h2></th></tr></thead><tbody>")),g+=h.outerHTML;this.$navigation&&(i&&(l="<ul>"+l+"</ul>"),this.$navigation.html(l)),this.$sortedTable.html(g+"</tbody>"),this.$sortedTable.trigger("sorted.bui.sortableTable")},e.prototype.comparer=function(b,c){return function(d,e){var f,g,h,i=function(b,c){var d=a(b).children("td").eq(c);return d.attr("data-sort-value")?d.attr("data-sort-value"):d.text()};return g=i(d,b),h=i(e,b),f=a.isNumeric(g)&&a.isNumeric(h)?g-h:g.localeCompare(h),"desc"===c?-1*f:f}};var f=a.fn.sortableTable;a.fn.sortableTable=d,a.fn.sortableTable.Constructor=e,
